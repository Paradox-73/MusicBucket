...
export const MusicTasteAnalyzer: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="mb-8">
        <div className="text-6xl font-bold text-green-500 mb-2">{score}/100</div>
        <p className="text-gray-600">Based on library size, artist diversity, and music obscurity</p>
      </div>
